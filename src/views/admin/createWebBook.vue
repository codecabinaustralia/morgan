<template>
    <div class="w-full flex bg-gray-100">
        ...
        <div style="z-index: 9999999999999999999999999" v-if="!loading && currentAsset" class="w-full bg-vgray bg-opacity-90 h-screen fixed top-0 left-0 items-center flex justify-center">
            <div class="w-1/2 ml-56 max-h-1/2 overflow-y-scroll bg-white rounded shadow" style="z-index: 9999999999999999999999999">
                ...
                <assetExecutiveSummary v-if="currentAsset.widget.type == 'executiveSummary'" :asset="currentAsset.widget" />
                ...
                <assetImageGalleryList v-if="currentAsset.widget.type == 'imageGalleryList'" :asset="currentAsset.widget" />
                ...
                <preloader class="bg-white rounded-lg p-4 h-20 w-20 mx-auto flex items-center justify-center" />
                    ...
                    <div v-if="!loading" class="bg-white rounded-lg p-4 flex space-x-2 mb-4">
                        <div class="w-full flex h-12 items-center space-x-4">
                            ...
                            <div class="flex-grow">
                                <input type="text" v-model="webbook.sections[sectionId].title" class="input w-full " placeholder="eg: Executive Summary">
                            </div>
                        </div>
                    </div>
                    ...
                    <div v-if="!loading" class="bg-white rounded-lg p-4 flex space-x-2">
                        ...
                        <div
                            ...
                            <div class="w-40 flex flex-wrap justify-center" v-for="(i, vindex) in items" :key="vindex">
                                <div @click="setAsset(i)" :style="currentTenant.primaryColor ? `color:${currentTenant.primaryColor}; `: ''"
                            ...
                            <div class="w-full flex flex-wrap cursor-move">
                                ...
                                <div v-for="(a, aIndex) in webbook.sections[sectionId].widgets" :key="aIndex"
                                    ...
                                    <div class="flex-shrink flex h-full items-center">
                                        <span @click="currentAsset = {widgetIndex: aIndex, widget: a}" :style="currentTenant.primaryColor ? `background-color:${currentTenant.primaryColor}`: ''"
                ...
                <div  class="w-1/4 pl-2">
                    <div v-if="!loading" class="bg-white rounded-lg p-4 w-full">
                        <span @click="preview()"
                            ...
                            Preview</span>
                        <div @click="saveWebbook()" :style="currentTenant.primaryColor ? `background-color:${currentTenant.primaryColor}`: ''"
...
export default {
    ...
    methods: {
        preview(){
            ...
            this.$router.push({name: "Preview", target: "_blank"})
        },
        async saveWebbook(){
