<template>
    <div class="w-full flex flex-wrap relative">
        ...
        <div class="w-full flex flex-wrap relative justify-center mb-2 p-6">
                <div class="w-full flex justify-center">
                    <img v-if="!imageLoading && !value.image" src="https://developers.elementor.com/docs/assets/img/elementor-placeholder-image.png" alt="placeholder" class="w-40 h20 rounded shadow">
                ...
                <div class="w-full flex justify-center">
                    <label for="image">
                    <div class="h-12 w-32 flex items-center justify-center hover:text-white mt-2 rounded bg-gray-200 text-sm text-vgray cursor-pointer hover:bg-vgreen ">Upload</div>
