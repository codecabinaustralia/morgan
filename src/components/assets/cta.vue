    ...
    <div class="w-full flex flex-wrap relative">
        ...
        <div class="w-full p-6">
            <div class="w-full relative mb-2">
                <input v-model="value.title" type="text" class="input outline-none focus:text-vgreen focus:border-vgreen">
                <div class="bg-white rounded header-medium text-vgreen absolute text-xs top-0 left-0 -mt-2 ml-2 px-2">
                    Header Text</div>
            </div>

            <div class="w-full relative mb-2">
                <input v-model="value.text" type="text" class="input outline-none focus:text-vgreen focus:border-vgreen">
                <div class="bg-white rounded header-medium text-vgreen absolute text-xs top-0 left-0 -mt-2 ml-2 px-2">
                    Body Text</div>
            </div>

            <div class="w-full relative mb-2">
                <input v-model="value.buttonText" type="text" class="input outline-none focus:text-vgreen focus:border-vgreen">
                <div class="bg-white rounded header-medium text-vgreen absolute text-xs top-0 left-0 -mt-2 ml-2 px-2">
                    Button Text</div>
            </div>
